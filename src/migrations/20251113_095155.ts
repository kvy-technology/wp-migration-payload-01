...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  `)
  await db.run(sql`INSERT INTO \`__new_posts_rels\`("id", "order", "parent_id", "path", "posts_id", "users_id") SELECT "id", "order", "parent_id", "path", "posts_id", "users_id" FROM \`posts_rels\`;`)
